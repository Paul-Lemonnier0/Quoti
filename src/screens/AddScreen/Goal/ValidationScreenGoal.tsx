...
type ValidationScreenGoalProps = NativeStackScreenProps<AddScreenStackType, "ValidationScreenGoal">

const ValidationScreenGoal: FC<ValidationScreenGoalProps> = ({navigation}) => {
            ...
            <View style={styles.container}>
                <View style={styles.header}>
                    <View>
                        ...
                        <TitleText text="Nouvel goal" style={{color: fontGray}}/>
                    </View>
  ...
  export default ValidationScreenGoal;