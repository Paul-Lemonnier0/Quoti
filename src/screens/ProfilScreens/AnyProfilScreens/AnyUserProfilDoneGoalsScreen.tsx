...
type AnyUserProfilDoneGoalsScreenProps =
  NativeStackScreenProps<SocialScreenStackType, "AnyUserProfilDoneGoalsScreen"> | 
  NativeStackScreenProps<HomeStackParamsList, "AnyUserProfilDoneGoalsScreen">

const AnyUserProfilDoneGoalsScreen: FC<AnyUserProfilDoneGoalsScreenProps> = ({navigation, route}) => {
    ...
    <UsualScreen>
      <View style={styles.container}>
        ...
        <View style={styles.body}>
            ...
            {
              isLoading ?
              <Goals_SkeletonList isPresentation={true} /> :
...
export default AnyUserProfilDoneGoalsScreen