...
import { getAllOwnHabits } from '../../../firebase/Firestore_Habits_Primitives'
...
type AnyUserProfilHabitsScreenProps = 
  NativeStackScreenProps<SocialScreenStackType, "AnyUserProfilHabitsScreen"> | 
  NativeStackScreenProps<HomeStackParamsList, "AnyUserProfilHabitsScreen">

const AnyUserProfilHabitsScreen: FC<AnyUserProfilHabitsScreenProps> = ({navigation, route}) => {
  ...
  useEffect(() => {
    const handleFetchUserHabits = async() => {
      ...
      const {habits} = await getAllOwnHabits(detailledUser.email)
...
export default AnyUserProfilHabitsScreen